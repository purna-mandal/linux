...
#define PIC32_LCD_CONFIG_ENABLE		BIT(31)
#define PIC32_LCD_CONFIG_CURSOR		BIT(30)
#define PIC32_LCD_CONFIG_NEG_V		BIT(28)
#define PIC32_LCD_CONFIG_NEG_H		BIT(27)
#define PIC32_LCD_CONFIG_NEG_DE		BIT(26)
#define PIC32_LCD_CONFIG_PCLKPOL	BIT(22)
#define PIC32_LCD_CONFIG_GAMMA		BIT(20)
#define PIC32_LCD_CONFIG_FORCEBLANK	BIT(19)
#define PIC32_LCD_CONFIG_YUV		BIT(9)
