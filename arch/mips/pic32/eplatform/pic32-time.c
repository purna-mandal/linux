...
void __init pic32_clk_init(void)
{
	...
	pic32_clk_add("pic32-uart", cpu_rate);
	pic32_clk_add("pic32-rtc", cpu_rate);
	pic32_clk_add("pic32-ether", cpu_rate);
	pic32_clk_add("pic32-i2c.0", cpu_rate);
	pic32_clk_add("pic32-i2c.1", cpu_rate);
	pic32_clk_add("pic32-i2c.2", cpu_rate);
	pic32_clk_add("pic32-i2c.3", cpu_rate);
	pic32_clk_add("pic32-i2c.4", cpu_rate);
}
