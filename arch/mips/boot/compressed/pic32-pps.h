 ...
 */
#ifndef _ASM_PIC32_PPS_H
#define _ASM_PIC32_PPS_H

/*
 * This is a complete, yet overy simplistic and unoptomized, PIC32MZ PPS
 * configuration selection interface. To be replaced later with pin control
 * support.
 *
 * Potential improvements:
 *  - use a faster method for lookup,
 *  - be thread safe, and also
 *  - keep track of re-purposing pins.
 */
